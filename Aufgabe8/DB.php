...
class DB {
	...
	public function add(array $daten) {
		$statement = $this->connection->prepare (  'INSERT INTO mockupdatatable (vorname, nachname, email, ipnr) 
		VALUES (?,?,?,?)' );
     ...
     * hier fehlt die SQL-Anfrage
     */
	// für das editieren, wir ändern Einträge
	public function edit(array $daten) {
	    //print_r($daten); debug funktion
